            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    @foreach ($inquiries as $index => $inquiry)
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>City:</th>
                                                <td>
                                                    {{ $states[optional(optional($inquiry->cropManagement)->farmer)->state] ?? 'Unknown State' }},
                                                    {{ $City[optional(optional($inquiry->cropManagement)->farmer)->district] ?? 'Unknown District' }},
                                                    {{ optional(optional($inquiry->cropManagement)->farmer)->town ?? 'Unknown Town' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Date:</th>
                        ...
                        @if (($index + 1) % 3 == 0)
                            <!-- Close the row after every three farmers -->
                </div>
                <div class="row">
                    @endif
                    @endforeach
