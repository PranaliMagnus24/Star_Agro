                ...
                <div class="modal-body">
                    <form id="inquiryForm" action="{{ route('home.cropsInquiry') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="user_city">{{ __('messages.City') }}</label>
...
<script>
                    ...
                    if (data.success) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href ='{{ route('wallet.management.index') }}';
                            }
                        });
                    }
                },
    ...
    document.getElementById('inquiryForm').addEventListener('submit', function(event) {
        ...
        const cropId = document.getElementById('crop_management_id').value;
