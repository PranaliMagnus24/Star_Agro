<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{ route('dashboard')}}" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">{{ __('messages.StarAgro') }}</span>
      </a>
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
              <li class="notification-item">
                ...
                <div>
                  <h4><a href="{{ url('language/en') }}" class="{{ App::getLocale() === 'en' ? 'active' : '' }}">English</a></h4>
                </div>
              </li>
              <li>
              ...
              <li class="notification-item">
                <i class="bi bi-check-circle text-success"></i>
                <div>
                    <h4><a href="{{ url('language/mr') }}" class="{{ App::getLocale() === 'mr' ? 'active' : '' }}">Marathi</a></h4>
                  </div>
              </li>
              <li>
                <hr class="dropdown-divider">
              ...
              <li class="notification-item">
                <i class="bi bi-check-circle text-success"></i>
                <div>
                    <h4><a href="{{ url('language/hi') }}" class="{{ App::getLocale() === 'hi' ? 'active' : '' }}">Hindi</a></h4>
                  </div>
              </li>
            </ul>
          </li>
